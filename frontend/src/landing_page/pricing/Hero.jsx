                ...
                <div className="row p-5 mt-5 border-bottom text-center" >
                    ...
                    <div className="row p-5 mt-5 text-center">
                        ...
                        <div className="col-4 p-4">
                            ...
                            <p className='text-muted'>Flat ₹ 20 or 0.03% (whichever is lower) per<br /> executed order on intraday trades across<br /> equity, currency, and commodity trades. Flat ₹20 on all option trades.</p>
                        </div>
